...
const { authRouter, BlockRouter, storageAreaRouter, CategorieRouter, Block_PartRouter, CommunicationsChannelRouter, TruckRouter, DriverRouter, ContainerRouter, CustomFeeRouter, ShipRouter, ShipOwnerRouter, QuayRouter, TypeRouter, ReservationRouter } = require("./v1")
